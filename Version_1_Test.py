...
class SampleApp(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.frames = {}
        for F in (StartPage, register_page, login_page, Cafe_menu):
...
class login_page(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.login_password_entry = tk.Entry(self)
    ...
    def login_verify(self):
        ...
        if self.verify_gmail in list_of_files:
            ...
            if self.verify_password in verify:
                ...
                self.controller.show_frame("Cafe_menu")
            else:   
...
class Cafe_menu(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.controller = controller
        StartPage.banner(self)
        self.delivery_button = tk.Button(self, text = "Delivery", height = 5, width = 10)
        self.delivery_button.place(x=110, y= 170)
        self.pickup_button = tk.Button(self, text = "Pickup", height = 5, width = 10)
