...
class Main(tk.Tk):
    ...
    def __init__(self, *args, **kwargs): #Initialising attributes of class
        ...
        manager.geometry("%dx%d" % (self.window_width, self.window_height))
        ...
        self.windows["gym_store"] = gym_store( manager=self, parent=manager) #Creates gym_store window
        ...
        self.windows["gym_store"].grid(row=0, column=0, sticky="nsew")#Geometry manager organising widgets for gym_store 
...
class delivery_or_pickup(tk.Frame): #delivery_or_pickup class
    ...
    def delivery(self):
        ...
        self.manager.show_window("gym_store")
    
    def pickup(self):
        self.manager.show_window("gym_store")
class gym_store(tk.Frame):
    def __init__(self, parent, manager): #Initializes attributes
        tk.Frame.__init__(self, parent) #Initializes frame 
        self.manager = manager #Declares self.manager as manager (for window controlling)
        manager.geometry("800x800")
        #test = tk.Label(self, text = "HI")
        ##test.pack(side = tk.LEFT)
        #test.pack_propagate(0)
        #test2 = tk.Label(self, text = "YOO")
        ##test2.pack(side=tk.RIGHT)
        #test2.pack_propagate(0)
