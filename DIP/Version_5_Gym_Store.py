...
class barbells_page(tk.Frame):  
    def __init__(self, parent, manager): #Initializes attributes
        ...
        fourtyfivekgs_barbell_checkbutton = tk.Checkbutton(FrameThree, text ="Barbell 45kgs \t\t\t", variable = ItemVar9, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=1, sticky =W)
        ...
        fiftyfivekgs_barbell_checkbutton = tk.Checkbutton(FrameThree, text ="Barbell 55kgs \t", variable = ItemVar11, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=3, sticky =W)
        sixtykgs_barbell_checkbutton = tk.Checkbutton(FrameThree, text ="Barbell 60kgs\t", variable = ItemVar12, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=4, sticky =W)
        sixtyfivekgs_barbell_checkbutton = tk.Checkbutton(FrameThree, text ="Barbell 65kgs \t", variable = ItemVar13, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=5, sticky =W)
        seventyfivekgs_barbell_checkbutton = tk.Checkbutton(FrameThree, text ="Barbell 70kgs \t", variable = ItemVar14, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=6, sticky =W)
        seventyfivekgs_barbell_checkbutton = tk.Checkbutton(FrameThree, text ="Barbell 75kgs \t", variable = ItemVar15, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=7, sticky =W)
        eightykgs_barbell_checkbutton = tk.Checkbutton(FrameThree, text ="Barbell 80kgs \t",variable = ItemVar16, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=8, sticky =W)
        fourtyfivekgs_barbell_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable = variable_fourtyfivekgs_barbell, state = DISABLED)
        fourtyfivekgs_barbell_entry.grid(row =1, column = 1)
        fiftykgs_barbell_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable = variable_fiftykgs_barbell, state = DISABLED)
        fiftykgs_barbell_entry.grid(row =2, column = 1)
        fiftyfivekgs_barbell_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable =variable_fiftyfivekgs_barbell, state = DISABLED)
        fiftyfivekgs_barbell_entry.grid(row =3, column = 1)
        sixtykgs_barbell_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable =variable_sixtykgs_barbell, state = DISABLED)
        sixtykgs_barbell_entry.grid(row =4, column = 1)
        sixtyfivekgs_barbell_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable = variable_sixtyfivekgs_barbell, state = DISABLED)
        sixtyfivekgs_barbell_entry.grid(row =5, column = 1)
        seventykgs_barbell_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable = variable_sixtykgs_barbell, state = DISABLED)
        seventykgs_barbell_entry.grid(row =6, column = 1)
        seventyfivekgs_barbell_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable = variable_sixtyfivekgs_barbell, state = DISABLED)
        seventyfivekgs_barbell_entry.grid(row =7, column = 1)
        eightykgs_barbell_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6, textvariable = variable_seventykgs_barbell, state = DISABLED)
...
class dumbbells_page(tk.Frame):  
    def __init__(self, parent, manager): #Initializes attributes
        ...
        SecondLabel.grid(row=0,column=0)
        fourtyfivekgs_dumbbell_checkbutton = tk.Checkbutton(FrameThree, text ="Dumbbell 45kgs \t\t\t", variable = ItemVar9, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=1, sticky =W)
        fiftykgs_dumbbell_checkbutton = tk.Checkbutton(FrameThree, text ="Dumbbell 50kgs \t", variable = ItemVar10, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=2, sticky =W)
        fiftyfivekgs_dumbbell_checkbutton = tk.Checkbutton(FrameThree, text ="Dumbbell 55kgs \t", variable = ItemVar11, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=3, sticky =W)
        sixtykgs_dumbbell_checkbutton = tk.Checkbutton(FrameThree, text ="Dumbbell 60kgs\t", variable = ItemVar12, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=4, sticky =W)
        sixtyfivekgs_dumbbell_checkbutton = tk.Checkbutton(FrameThree, text ="Dumbbell 65kgs \t", variable = ItemVar13, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=5, sticky =W)
        seventyfivekgs_dumbbell_checkbutton = tk.Checkbutton(FrameThree, text ="Dumbbell 70kgs \t", variable = ItemVar14, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=6, sticky =W)
        seventyfivekgs_dumbbell_checkbutton = tk.Checkbutton(FrameThree, text ="Dumbbell 75kgs \t", variable = ItemVar15, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=7, sticky =W)
        eightykgs_dumbbell_checkbutton = tk.Checkbutton(FrameThree, text ="Dumbbell 80kgs \t",variable = ItemVar16, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=8, sticky =W)
        fourtyfivekgs_dumbbell_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable = variable_fourtyfivekgs_dumbbell, state = DISABLED)
        fourtyfivekgs_dumbbell_entry.grid(row =1, column = 1)
        fiftykgs_dumbbell_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable = variable_fiftykgs_dumbbell, state = DISABLED)
        fiftykgs_dumbbell_entry.grid(row =2, column = 1)
        fiftyfivekgs_dumbbell_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable =variable_fiftyfivekgs_dumbbell, state = DISABLED)
        fiftyfivekgs_dumbbell_entry.grid(row =3, column = 1)
        sixtykgs_dumbbell_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable =variable_sixtykgs_dumbbell, state = DISABLED)
        sixtykgs_dumbbell_entry.grid(row =4, column = 1)
        sixtyfivekgs_dumbbell_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable = variable_sixtyfivekgs_dumbbell, state = DISABLED)
        sixtyfivekgs_dumbbell_entry.grid(row =5, column = 1)
        seventykgs_dumbbell_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable = variable_sixtykgs_dumbbell, state = DISABLED)
        seventykgs_dumbbell_entry.grid(row =6, column = 1)
        seventyfivekgs_dumbbell_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable = variable_sixtyfivekgs_dumbbell, state = DISABLED)
        seventyfivekgs_dumbbell_entry.grid(row =7, column = 1)
        eightykgs_dumbbell_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6, textvariable = variable_seventykgs_dumbbell, state = DISABLED)
...
class machines_page(tk.Frame):  
    def __init__(self, parent, manager): #Initializes attributes
        tk.Frame.__init__(self, parent) #Initializes frame 
        self.manager = manager #Declares self.manager as manager (for window controlling)
        machines_top_border = Frame(self, width = 1366, height = 55, bd = 14, relief ="raise", background = "light blue")
        machines_top_border.place(x=0,y=0) #Machines top border
        self.TitleImage = PhotoImage(file="images/GymHomeBanner.png") 
        self.title_label = tk.Label(self, image=self.TitleImage, bd=3).place(x=0, y=50) #Banner for welcoming
        machines_bottom_border = Frame(self, width = 1366, height = 55, bd = 14, relief ="raise", background = "light blue")
        machines_bottom_border.place(x=0, y=150) #Machines bottom border
        ...
        ItemVar15 = IntVar()
        ItemVar16 = IntVar()
        variable_treadmill = StringVar()
        variable_chestpress = StringVar()
        variable_pecfly = StringVar()
        variable_seatedrow = StringVar()
        variable_latpulldown = StringVar()
        variable_ergometer = StringVar()
        variable_stairmaster = StringVar()
        variable_smithmachine = StringVar()
        variable_abcrunch = StringVar()
        variable_legextension = StringVar()
        variable_legpress = StringVar()
        variable_elliptical = StringVar()
        variable_standingcalfraise = StringVar()
        variable_shoulderpress = StringVar()
        variable_legcurls = StringVar()
        variable_deltoidraise = StringVar()
        ...
        FirstLabel.grid(row=0,column=0)
        treadmill_checkbutton = tk.Checkbutton(FrameTwo, text ="Treadmill\t\t\t\t" ,variable = ItemVar1, onvalue = 1, background = "light blue", offvalue = 0, font=('arial',13, 'bold')).grid(row=1, sticky =W)
        chestpress_checkbutton = tk.Checkbutton(FrameTwo, text ="Chest press " , variable = ItemVar2, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=2, sticky =W)
        pecfly_checkbutton = tk.Checkbutton(FrameTwo, text ="Pecfly " , variable = ItemVar3, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=3, sticky =W)
        seatedrow_checkbutton = tk.Checkbutton(FrameTwo, text ="Seated row ", variable = ItemVar4, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=4, sticky =W)
        latpulldown_checkbutton = tk.Checkbutton(FrameTwo, text ="Lat pull down ",variable = ItemVar5, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=5, sticky =W)
        ergometer_checkbutton = tk.Checkbutton(FrameTwo, text ="Ergometer ",variable = ItemVar6, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=6, sticky =W)
        stairmaster_checkbutton = tk.Checkbutton(FrameTwo, text ="Stairmaster ", variable = ItemVar7, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=7, sticky =W)
        smithmachine_checkbutton = tk.Checkbutton(FrameTwo, text ="Smithmachine ", variable = ItemVar8, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=8, sticky =W)
        treadmill_entry = tk.Entry(FrameTwo, font=('arial',13, 'bold'), bd = 8, width = 6, justify ='left',textvariable = variable_treadmill, state = DISABLED)
        treadmill_entry.grid(row =1, column = 1)
        chestpress_entry = tk.Entry(FrameTwo, font=('arial',13, 'bold'), bd = 8, width = 6, justify ='left',textvariable = variable_chestpress, state = DISABLED)
        chestpress_entry.grid(row =2, column = 1)
        pecfly_dumbbell_entry = tk.Entry(FrameTwo, font=('arial',13, 'bold'), bd = 8, width = 6, justify ='left',textvariable = variable_pecfly, state = DISABLED)
        pecfly_dumbbell_entry.grid(row =3, column = 1)
        seatedrow_entry = tk.Entry(FrameTwo, font=('arial',13, 'bold'), bd = 8, width = 6, justify ='left',textvariable = variable_seatedrow, state = DISABLED)
        seatedrow_entry.grid(row =4, column = 1)
        latpulldown_entry = tk.Entry(FrameTwo, font=('arial',13, 'bold'), bd = 8, width = 6, justify ='left',textvariable = variable_latpulldown, state = DISABLED)
        latpulldown_entry.grid(row =5, column = 1)
        ergometer_entry = tk.Entry(FrameTwo, font=('arial',13, 'bold'), bd = 8, width = 6, justify ='left',textvariable = variable_ergometer ,state = DISABLED)
        ergometer_entry.grid(row =6, column = 1)
        stairmaster_entry = tk.Entry(FrameTwo, font=('arial',13, 'bold'), bd = 8, width = 6, justify ='left',textvariable = variable_stairmaster, state = DISABLED)
        stairmaster_entry.grid(row =7, column = 1)
        smithmachine_entry = tk.Entry(FrameTwo, font=('arial',13, 'bold'), bd = 8, width = 6, justify ='left', textvariable = variable_smithmachine, state = DISABLED)
        ...
        SecondLabel.grid(row=0,column=0)
        row_checkbutton = tk.Checkbutton(FrameThree, text ="Ab crunch \t\t\t\t", variable = ItemVar9, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=1, sticky =W)
        legextension_checkbutton = tk.Checkbutton(FrameThree, text ="Leg extension \t", variable = ItemVar10, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=2, sticky =W)
        legpress_checkbutton = tk.Checkbutton(FrameThree, text ="Leg press \t", variable = ItemVar11, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=3, sticky =W)
        elliptical_checkbutton = tk.Checkbutton(FrameThree, text ="Elliptical\t", variable = ItemVar12, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=4, sticky =W)
        standingcalfraise_checkbutton = tk.Checkbutton(FrameThree, text ="Standing calf raise \t", variable = ItemVar13, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=5, sticky =W)
        shoulderpress_checkbutton = tk.Checkbutton(FrameThree, text ="Shoulder press \t", variable = ItemVar14, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=6, sticky =W)
        legcurls_checkbutton = tk.Checkbutton(FrameThree, text ="Leg curls \t", variable = ItemVar15, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=7, sticky =W)
        deltoidraise_checkbutton = tk.Checkbutton(FrameThree, text ="Deltoid raise \t",variable = ItemVar16, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=8, sticky =W)
        abcrunch_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable = variable_abcrunch, state = DISABLED)
        abcrunch_entry.grid(row =1, column = 1)
        legextension_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable = variable_legextension, state = DISABLED)
        legextension_entry.grid(row =2, column = 1)
        legpress_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable =variable_legpress, state = DISABLED)
        legpress_entry.grid(row =3, column = 1)
        elliptical_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable =variable_elliptical, state = DISABLED)
        elliptical_entry.grid(row =4, column = 1)
        standingcalfraise_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable = variable_standingcalfraise, state = DISABLED)
        standingcalfraise_entry.grid(row =5, column = 1)
        shoulderpress_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable = variable_shoulderpress, state = DISABLED)
        shoulderpress_entry.grid(row =6, column = 1)
        legcurls_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable = variable_legcurls, state = DISABLED)
        legcurls_entry.grid(row =7, column = 1)
        deltoidraise_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6, textvariable = variable_deltoidraise, state = DISABLED)
...
class plates_page(tk.Frame):  
    def __init__(self, parent, manager): #Initializes attributes
        tk.Frame.__init__(self, parent) #Initializes frame 
        self.manager = manager #Declares self.manager as manager (for window controlling)
        plates_top_border = Frame(self, width = 1366, height = 55, bd = 14, relief ="raise", background = "light blue")
        ...
        plates_bottom_border = Frame(self, width = 1366, height = 55, bd = 14, relief ="raise", background = "light blue")
        plates_bottom_border.place(x=0, y=150) #Plates bottom border 
        ...
        ItemVar15 = IntVar()
        ItemVar16 = IntVar()
        variable_fivekgs_plate = StringVar()
        variable_tenkgs_plate = StringVar()
        variable_fifteenkgs_plate = StringVar()
        variable_twentykgs_plate = StringVar()
        variable_twentyfivekgs_plate = StringVar()
        variable_thirtykgs_plate = StringVar()
        variable_thirtyfivekgs_plate = StringVar()
        variable_fourtykgs_plate = StringVar()
        variable_fourtyfivekgs_plate = StringVar()
        variable_fiftykgs_plate = StringVar()
        variable_fiftyfivekgs_plate = StringVar()
        variable_sixtykgs_plate = StringVar()
        variable_sixtyfivekgs_plate = StringVar()
        variable_seventykgs_plate = StringVar()
        variable_seventyfivekgs_plate =  StringVar()
        variable_eightykgs_plate = StringVar()
        ...
        FirstLabel.grid(row=0,column=0)
        fivekgs_plate_checkbutton = tk.Checkbutton(FrameTwo, text ="Plate 5kgs\t\t\t" ,variable = ItemVar1, onvalue = 1, background = "light blue", offvalue = 0, font=('arial',13, 'bold')).grid(row=1, sticky =W)
        tenkgs_plate_checkbutton = tk.Checkbutton(FrameTwo, text ="Plate 10kgs " , variable = ItemVar2, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=2, sticky =W)
        fifteenkgs_plate_checkbutton = tk.Checkbutton(FrameTwo, text ="Plate 15kgs " , variable = ItemVar3, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=3, sticky =W)
        twentykgs_plate_checkbutton = tk.Checkbutton(FrameTwo, text ="Plate 20kgs ", variable = ItemVar4, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=4, sticky =W)
        twentyfivekgs_plate_checkbutton = tk.Checkbutton(FrameTwo, text ="Plate 25kgs ",variable = ItemVar5, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=5, sticky =W)
        thirtykgs_plate_checkbutton = tk.Checkbutton(FrameTwo, text ="Plate 30kgs ",variable = ItemVar6, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=6, sticky =W)
        thirtyfivekgs_plate_checkbutton = tk.Checkbutton(FrameTwo, text ="Plate 35kgs ", variable = ItemVar7, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=7, sticky =W)
        fourtykgs_plate_checkbutton = tk.Checkbutton(FrameTwo, text ="Plate 40kgs ", variable = ItemVar8, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=8, sticky =W)
        fivekgs_plate_entry = tk.Entry(FrameTwo, font=('arial',13, 'bold'), bd = 8, width = 6, justify ='left',textvariable = variable_fivekgs_plate, state = DISABLED)
        fivekgs_plate_entry.grid(row =1, column = 1)
        tenkgs_plate_entry = tk.Entry(FrameTwo, font=('arial',13, 'bold'), bd = 8, width = 6, justify ='left',textvariable = variable_tenkgs_plate, state = DISABLED)
        tenkgs_plate_entry.grid(row =2, column = 1)
        fifteenkgs_plate_entry = tk.Entry(FrameTwo, font=('arial',13, 'bold'), bd = 8, width = 6, justify ='left',textvariable = variable_fifteenkgs_plate, state = DISABLED)
        fifteenkgs_plate_entry.grid(row =3, column = 1)
        twentykgs_plate_entry = tk.Entry(FrameTwo, font=('arial',13, 'bold'), bd = 8, width = 6, justify ='left',textvariable = variable_twentykgs_plate, state = DISABLED)
        twentykgs_plate_entry.grid(row =4, column = 1)
        twentyfivekgs_plate_entry = tk.Entry(FrameTwo, font=('arial',13, 'bold'), bd = 8, width = 6, justify ='left',textvariable = variable_twentyfivekgs_plate, state = DISABLED)
        twentyfivekgs_plate_entry.grid(row =5, column = 1)
        thirtykgs_plate_entry = tk.Entry(FrameTwo, font=('arial',13, 'bold'), bd = 8, width = 6, justify ='left',textvariable = variable_thirtykgs_plate ,state = DISABLED)
        thirtykgs_plate_entry.grid(row =6, column = 1)
        thirtyfivekgs_plate_entry = tk.Entry(FrameTwo, font=('arial',13, 'bold'), bd = 8, width = 6, justify ='left',textvariable = variable_thirtyfivekgs_plate, state = DISABLED)
        thirtyfivekgs_plate_entry.grid(row =7, column = 1)
        fourtykgs_plate_entry = tk.Entry(FrameTwo, font=('arial',13, 'bold'), bd = 8, width = 6, justify ='left', textvariable = variable_fourtykgs_plate, state = DISABLED)
        ...
        SecondLabel.grid(row=0,column=0)
        fourtyfivekgs_plate_checkbutton = tk.Checkbutton(FrameThree, text ="Plate 45kgs \t\t\t", variable = ItemVar9, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=1, sticky =W)
        fiftykgs_plate_checkbutton = tk.Checkbutton(FrameThree, text ="Plate 50kgs \t", variable = ItemVar10, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=2, sticky =W)
        fiftyfivekgs_plate_checkbutton = tk.Checkbutton(FrameThree, text ="Plate 55kgs \t", variable = ItemVar11, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=3, sticky =W)
        sixtykgs_plate_checkbutton = tk.Checkbutton(FrameThree, text ="Plate 60kgs\t", variable = ItemVar12, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=4, sticky =W)
        sixtyfivekgs_plate_checkbutton = tk.Checkbutton(FrameThree, text ="Plate 65kgs \t", variable = ItemVar13, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=5, sticky =W)
        seventyfivekgs_plate_checkbutton = tk.Checkbutton(FrameThree, text ="Plate 70kgs \t", variable = ItemVar14, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=6, sticky =W)
        seventyfivekgs_plate_checkbutton = tk.Checkbutton(FrameThree, text ="Plate 75kgs \t", variable = ItemVar15, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=7, sticky =W)
        eightykgs_plate_checkbutton = tk.Checkbutton(FrameThree, text ="Plate 80kgs \t",variable = ItemVar16, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=8, sticky =W)
        fourtyfivekgs_plate_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable = variable_fourtyfivekgs_plate, state = DISABLED)
        fourtyfivekgs_plate_entry.grid(row =1, column = 1)
        fiftykgs_plate_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable = variable_fiftykgs_plate, state = DISABLED)
        fiftykgs_plate_entry.grid(row =2, column = 1)
        fiftyfivekgs_plate_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable =variable_fiftyfivekgs_plate, state = DISABLED)
        fiftyfivekgs_plate_entry.grid(row =3, column = 1)
        sixtykgs_plate_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable =variable_sixtykgs_plate, state = DISABLED)
        sixtykgs_plate_entry.grid(row =4, column = 1)
        sixtyfivekgs_plate_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable = variable_sixtyfivekgs_plate, state = DISABLED)
        sixtyfivekgs_plate_entry.grid(row =5, column = 1)
        seventykgs_plate_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable = variable_sixtykgs_plate, state = DISABLED)
        seventykgs_plate_entry.grid(row =6, column = 1)
        seventyfivekgs_plate_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable = variable_sixtyfivekgs_plate, state = DISABLED)
        seventyfivekgs_plate_entry.grid(row =7, column = 1)
        eightykgs_plate_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6, textvariable = variable_seventykgs_plate, state = DISABLED)
