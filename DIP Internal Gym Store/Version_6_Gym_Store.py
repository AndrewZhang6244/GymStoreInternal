...
class plates_page(tk.Frame):  
    def __init__(self, parent, manager): #Initializes attributes
        ...
        SecondLabel.grid(row=0,column=0)
        fourtyfivekgs_plate_checkbutton = tk.Checkbutton(FrameThree, text ="Plate 45kgs ($90.00)\t\t", command = self.plate_checked_checkbuttons,variable = self.ItemVar57, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=1, sticky =W)
        fiftykgs_plate_checkbutton = tk.Checkbutton(FrameThree, text ="Plate 50kgs ($100.00)\t", command = self.plate_checked_checkbuttons,variable = self.ItemVar58, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=2, sticky =W)
        fiftyfivekgs_plate_checkbutton = tk.Checkbutton(FrameThree, text ="Plate 55kgs ($110.00)\t", command = self.plate_checked_checkbuttons,variable = self.ItemVar59, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=3, sticky =W)
        sixtykgs_plate_checkbutton = tk.Checkbutton(FrameThree, text ="Plate 60kgs ($120.00)\t", command = self.plate_checked_checkbuttons,variable = self.ItemVar60, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=4, sticky =W)
        sixtyfivekgs_plate_checkbutton = tk.Checkbutton(FrameThree, text ="Plate 65kgs ($130.00)\t", command = self.plate_checked_checkbuttons,variable = self.ItemVar61, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=5, sticky =W)
        seventyfivekgs_plate_checkbutton = tk.Checkbutton(FrameThree, text ="Plate 70kgs ($140.00)\t", command = self.plate_checked_checkbuttons,variable = self.ItemVar62, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=6, sticky =W)
        seventyfivekgs_plate_checkbutton = tk.Checkbutton(FrameThree, text ="Plate 75kgs ($150.00)\t", command = self.plate_checked_checkbuttons,variable = self.ItemVar63, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=7, sticky =W)
        eightykgs_plate_checkbutton = tk.Checkbutton(FrameThree, text ="Plate 80kgs ($160.00)\t",command = self.plate_checked_checkbuttons,variable = self.ItemVar64, onvalue = 1, offvalue = 0, font=('arial',13, 'bold'), background = "light blue").grid(row=8, sticky =W)
        ...
        self.seventykgs_plate_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable = self.variable_seventykgs_plate, state = DISABLED)
        self.seventykgs_plate_entry.grid(row =6, column = 1)
        self.seventyfivekgs_plate_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6,textvariable = self.variable_seventyfivekgs_plate, state = DISABLED)
        self.seventyfivekgs_plate_entry.grid(row =7, column = 1)
        self.eightykgs_plate_entry = tk.Entry(FrameThree, font=('arial',13, 'bold'), bd = 8, width = 6, textvariable = self.variable_eightykgs_plate, state = DISABLED)
...
class ordering_page(tk.Frame):  
    ...
    def reset_data(self):
        ...
        self.SubTotal.set("")
        self.TotalCost.set("")
        (app.windows["barbells_page"]).ItemVar1.set("0")
        (app.windows["barbells_page"]).ItemVar2.set("0")
        (app.windows["barbells_page"]).ItemVar3.set("0")
        (app.windows["barbells_page"]).ItemVar4.set("0")
        (app.windows["barbells_page"]).ItemVar5.set("0")
        (app.windows["barbells_page"]).ItemVar6.set("0")
        (app.windows["barbells_page"]).ItemVar7.set("0")
        (app.windows["barbells_page"]).ItemVar8.set("0")
        (app.windows["barbells_page"]).ItemVar9.set("0")
        (app.windows["barbells_page"]).ItemVar10.set("0")
        (app.windows["barbells_page"]).ItemVar11.set("0")
        (app.windows["barbells_page"]).ItemVar12.set("0")
        (app.windows["barbells_page"]).ItemVar13.set("0")
        (app.windows["barbells_page"]).ItemVar14.set("0")
        (app.windows["barbells_page"]).ItemVar15.set("0")
        (app.windows["barbells_page"]).ItemVar16.set("0")
        (app.windows["dumbbells_page"]).ItemVar17.set("0")
        (app.windows["dumbbells_page"]).ItemVar17.set("0")
        (app.windows["dumbbells_page"]).ItemVar17.set("0")
        (app.windows["dumbbells_page"]).ItemVar18.set("0")
        (app.windows["dumbbells_page"]).ItemVar19.set("0")
        (app.windows["dumbbells_page"]).ItemVar20.set("0")
        (app.windows["dumbbells_page"]).ItemVar21.set("0")
        (app.windows["dumbbells_page"]).ItemVar22.set("0")
        (app.windows["dumbbells_page"]).ItemVar23.set("0")
        (app.windows["dumbbells_page"]).ItemVar24.set("0")
        (app.windows["dumbbells_page"]).ItemVar25.set("0")
        (app.windows["dumbbells_page"]).ItemVar26.set("0")
        (app.windows["dumbbells_page"]).ItemVar27.set("0")
        (app.windows["dumbbells_page"]).ItemVar28.set("0")
        (app.windows["dumbbells_page"]).ItemVar29.set("0")
        (app.windows["dumbbells_page"]).ItemVar30.set("0")
        (app.windows["dumbbells_page"]).ItemVar31.set("0")
        (app.windows["dumbbells_page"]).ItemVar32.set("0")
        (app.windows["machines_page"]).ItemVar33.set("0")
        (app.windows["machines_page"]).ItemVar34.set("0")
        (app.windows["machines_page"]).ItemVar35.set("0")
        (app.windows["machines_page"]).ItemVar36.set("0")
        (app.windows["machines_page"]).ItemVar37.set("0")
        (app.windows["machines_page"]).ItemVar38.set("0")
        (app.windows["machines_page"]).ItemVar39.set("0")
        (app.windows["machines_page"]).ItemVar40.set("0")
        (app.windows["machines_page"]).ItemVar41.set("0")
        (app.windows["machines_page"]).ItemVar42.set("0")
        (app.windows["machines_page"]).ItemVar43.set("0")
        (app.windows["machines_page"]).ItemVar44.set("0")
        (app.windows["machines_page"]).ItemVar45.set("0")
        (app.windows["machines_page"]).ItemVar46.set("0")
        (app.windows["machines_page"]).ItemVar47.set("0")
        (app.windows["machines_page"]).ItemVar48.set("0")
        (app.windows["plates_page"]).ItemVar49.set("0")
        (app.windows["plates_page"]).ItemVar50.set("0")
        (app.windows["plates_page"]).ItemVar51.set("0")
        (app.windows["plates_page"]).ItemVar52.set("0")
        (app.windows["plates_page"]).ItemVar53.set("0")
        (app.windows["plates_page"]).ItemVar54.set("0")
        (app.windows["plates_page"]).ItemVar55.set("0")
        (app.windows["plates_page"]).ItemVar56.set("0")
        (app.windows["plates_page"]).ItemVar57.set("0")
        (app.windows["plates_page"]).ItemVar58.set("0")
        (app.windows["plates_page"]).ItemVar59.set("0")
        (app.windows["plates_page"]).ItemVar60.set("0")
        (app.windows["plates_page"]).ItemVar61.set("0")
        (app.windows["plates_page"]).ItemVar62.set("0")
        (app.windows["plates_page"]).ItemVar63.set("0")
        (app.windows["plates_page"]).ItemVar64.set("0")

        (app.windows["barbells_page"]).variable_fivekgs_barbell.set("0")
        (app.windows["barbells_page"]).variable_tenkgs_barbell.set("0")
        (app.windows["barbells_page"]).variable_fifteenkgs_barbell.set("0")
        (app.windows["barbells_page"]).variable_twentykgs_barbell.set("0")
        (app.windows["barbells_page"]).variable_twentyfivekgs_barbell.set("0")
        (app.windows["barbells_page"]).variable_thirtykgs_barbell.set("0")
        (app.windows["barbells_page"]).variable_thirtykgs_barbell.set("0")
        (app.windows["barbells_page"]).variable_fourtykgs_barbell.set("0")
        (app.windows["barbells_page"]).variable_fourtyfivekgs_barbell.set("0")
        (app.windows["barbells_page"]).variable_fiftykgs_barbell.set("0")
        (app.windows["barbells_page"]).variable_fiftyfivekgs_barbell.set("0")
        (app.windows["barbells_page"]).variable_sixtykgs_barbell.set("0")
        (app.windows["barbells_page"]).variable_sixtyfivekgs_barbell.set("0")
        (app.windows["barbells_page"]).variable_seventykgs_barbell.set("0")
        (app.windows["barbells_page"]).variable_seventyfivekgs_barbell.set("0")
        (app.windows["barbells_page"]).variable_eightykgs_barbell.set("0")

        (app.windows["dumbbells_page"]).variable_fivekgs_dumbbell.set("0")
        (app.windows["dumbbells_page"]).variable_tenkgs_dumbbell.set("0")
        (app.windows["dumbbells_page"]).variable_fifteenkgs_dumbbell.set("0")
        (app.windows["dumbbells_page"]).variable_twentykgs_dumbbell.set("0")
        (app.windows["dumbbells_page"]).variable_twentyfivekgs_dumbbell.set("0")
        (app.windows["dumbbells_page"]).variable_thirtykgs_dumbbell.set("0")
        (app.windows["dumbbells_page"]).variable_thirtyfivekgs_dumbbell.set("0")
        (app.windows["dumbbells_page"]).variable_fourtykgs_dumbbell.set("0")
        (app.windows["dumbbells_page"]).variable_fourtyfivekgs_dumbbell.set("0")
        (app.windows["dumbbells_page"]).variable_fiftykgs_dumbbell.set("0")
        (app.windows["dumbbells_page"]).variable_fiftyfivekgs_dumbbell.set("0")
        (app.windows["dumbbells_page"]).variable_sixtykgs_dumbbell.set("0")
        (app.windows["dumbbells_page"]).variable_sixtyfivekgs_dumbbell.set("0")
        (app.windows["dumbbells_page"]).variable_seventykgs_dumbbell.set("0")
        (app.windows["dumbbells_page"]).variable_seventyfivekgs_dumbbell.set("0")
        (app.windows["dumbbells_page"]).variable_eightykgs_dumbbell.set("0")

        (app.windows["machines_page"]).variable_treadmill.set("0")
        (app.windows["machines_page"]).variable_chestpress.set("0")
        (app.windows["machines_page"]).variable_pecfly.set("0")
        (app.windows["machines_page"]).variable_seatedrow.set("0")
        (app.windows["machines_page"]).variable_latpulldown.set("0")
        (app.windows["machines_page"]).variable_ergometer.set("0")
        (app.windows["machines_page"]).variable_stairmaster.set("0")
        (app.windows["machines_page"]).variable_smithmachine.set("0")
        (app.windows["machines_page"]).variable_abcrunch.set("0")
        (app.windows["machines_page"]).variable_legextension.set("0")
        (app.windows["machines_page"]).variable_legpress.set("0")
        (app.windows["machines_page"]).variable_elliptical.set("0")
        (app.windows["machines_page"]).variable_standingcalfraise.set("0")
        (app.windows["machines_page"]).variable_shoulderpress.set("0")
        (app.windows["machines_page"]).variable_legcurls.set("0")
        (app.windows["machines_page"]).variable_deltoidraise.set("0")

        (app.windows["plates_page"]).variable_fivekgs_plate.set("0")
        (app.windows["plates_page"]).variable_tenkgs_plate.set("0")
        (app.windows["plates_page"]).variable_fifteenkgs_plate.set("0")
        (app.windows["plates_page"]).variable_twentykgs_plate.set("0")
        (app.windows["plates_page"]).variable_twentyfivekgs_plate.set("0")
        (app.windows["plates_page"]).variable_thirtykgs_plate.set("0")
        (app.windows["plates_page"]).variable_thirtyfivekgs_plate.set("0")
        (app.windows["plates_page"]).variable_fourtykgs_plate.set("0")
        (app.windows["plates_page"]).variable_fourtyfivekgs_plate.set("0")
        (app.windows["plates_page"]).variable_fiftykgs_plate.set("0")
        (app.windows["plates_page"]).variable_fiftyfivekgs_plate.set("0")
        (app.windows["plates_page"]).variable_sixtykgs_plate.set("0")
        (app.windows["plates_page"]).variable_sixtyfivekgs_plate.set("0")
        (app.windows["plates_page"]).variable_seventykgs_plate.set("0")
        (app.windows["plates_page"]).variable_seventyfivekgs_plate.set("0")
        (app.windows["plates_page"]).variable_eightykgs_plate.set("0")
        (app.windows["plates_page"]).variable_eightykgs_plate.set("0")
