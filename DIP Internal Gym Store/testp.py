...
class ordering_page(tk.Frame):  
    ...
    def total_price(self):
        Item1=float((app.windows["barbells_page"]).barbells[5].get()) 
        Item2=float((app.windows["barbells_page"]).barbells[10].get()) 
        Item3=float((app.windows["barbells_page"]).barbells[15].get())
        Item4=float((app.windows["barbells_page"]).barbells[20].get())
        Item5=float((app.windows["barbells_page"]).barbells[25].get())
        Item6=float((app.windows["barbells_page"]).barbells[30].get())
        Item7=float((app.windows["barbells_page"]).barbells[35].get())
        Item8=float((app.windows["barbells_page"]).barbells[40].get())
        Item9=float((app.windows["barbells_page"]).barbells[45].get())
        Item10=float((app.windows["barbells_page"]).barbells[50].get())
        Item11=float((app.windows["barbells_page"]).barbells[55].get())
        Item12=float((app.windows["barbells_page"]).barbells[60].get())
        Item13=float((app.windows["barbells_page"]).barbells[65].get())
        Item14=float((app.windows["barbells_page"]).barbells[70].get())
        Item15=float((app.windows["barbells_page"]).barbells[75].get())
        Item16=float((app.windows["barbells_page"]).barbells[80].get())
      
        Item17=float((app.windows["dumbbells_page"]).dumbbells[5].get())
        Item18=float((app.windows["dumbbells_page"]).dumbbells[10].get())
        Item19=float((app.windows["dumbbells_page"]).dumbbells[15].get())
        Item20=float((app.windows["dumbbells_page"]).dumbbells[20].get())
        Item21=float((app.windows["dumbbells_page"]).dumbbells[25].get())
        Item22=float((app.windows["dumbbells_page"]).dumbbells[30].get())
        Item23=float((app.windows["dumbbells_page"]).dumbbells[35].get())
        Item24=float((app.windows["dumbbells_page"]).dumbbells[40].get())
        Item25=float((app.windows["dumbbells_page"]).dumbbells[45].get())
        Item26=float((app.windows["dumbbells_page"]).dumbbells[50].get())
        Item27=float((app.windows["dumbbells_page"]).dumbbells[55].get())
        Item28=float((app.windows["dumbbells_page"]).dumbbells[60].get())
        Item29=float((app.windows["dumbbells_page"]).dumbbells[65].get())
        Item30=float((app.windows["dumbbells_page"]).dumbbells[70].get())
        Item31=float((app.windows["dumbbells_page"]).dumbbells[75].get())
        Item32=float((app.windows["dumbbells_page"]).dumbbells[80].get())
        
        Item33=float((app.windows["machines_page"]).machines[1].get())
        Item34=float((app.windows["machines_page"]).machines[2].get())
        Item35=float((app.windows["machines_page"]).machines[3].get())
        Item36=float((app.windows["machines_page"]).machines[4].get())
        Item37=float((app.windows["machines_page"]).machines[5].get())
        Item38=float((app.windows["machines_page"]).machines[6].get())
        Item39=float((app.windows["machines_page"]).machines[7].get())
        Item40=float((app.windows["machines_page"]).machines[8].get())
        Item41=float((app.windows["machines_page"]).machines[9].get())
        Item42=float((app.windows["machines_page"]).machines[10].get())
        Item43=float((app.windows["machines_page"]).machines[11].get())
        Item44=float((app.windows["machines_page"]).machines[12].get())
        Item45=float((app.windows["machines_page"]).machines[13].get())
        Item46=float((app.windows["machines_page"]).machines[14].get())
        Item47=float((app.windows["machines_page"]).machines[15].get())
        Item48=float((app.windows["machines_page"]).machines[16].get())

        Item49=float((app.windows["plates_page"]).plates[5].get())
        Item50=float((app.windows["plates_page"]).plates[10].get())
        Item51=float((app.windows["plates_page"]).plates[15].get())
        Item52=float((app.windows["plates_page"]).plates[20].get())
        Item53=float((app.windows["plates_page"]).plates[25].get())
        Item54=float((app.windows["plates_page"]).plates[30].get())
        Item55=float((app.windows["plates_page"]).plates[35].get())
        Item56=float((app.windows["plates_page"]).plates[40].get())
        Item57=float((app.windows["plates_page"]).plates[45].get())
        Item58=float((app.windows["plates_page"]).plates[50].get())
        Item59=float((app.windows["plates_page"]).plates[55].get())
        Item60=float((app.windows["plates_page"]).plates[60].get())
        Item61=float((app.windows["plates_page"]).plates[65].get())
        Item62=float((app.windows["plates_page"]).plates[70].get())
        Item63=float((app.windows["plates_page"]).plates[75].get())
        Item64=float((app.windows["plates_page"]).plates[80].get())
        ...
        if delivery_ask == 'yes':
            ...
            if address_ask is not None:
                if address_ask == "":
                    ...
                    self.tax_float = ((self.price_of_barbells + self.price_of_dumbbells + self.price_of_machines + self.price_of_plates + 5.50 )*0.15)
                    ...
                    total_cost_float = '$ ' + str ('%.2f'%(self.price_of_barbells + self.price_of_dumbbells + self.price_of_machines + self.price_of_plates + self.tax_float + 5.5))
                    self.TotalCost.set(total_cost_float)
            else:
                self.DeliveryTip.set("0")
                self.tax_float = ((self.price_of_barbells + self.price_of_dumbbells + self.price_of_machines + self.price_of_plates )*0.15)
                SubTotalofITEMS = '$ ' +str ('%.2f'%(self.price_of_barbells + self.price_of_dumbbells + self.price_of_machines + self.price_of_plates))
                self.SubTotal.set(SubTotalofITEMS)
                total_cost_float = '$ ' + str ('%.2f'%(self.price_of_barbells + self.price_of_dumbbells + self.price_of_machines + self.price_of_plates + self.tax_float))
                self.TotalCost.set(total_cost_float)
        else:
            self.DeliveryTip.set("0")
            self.tax_float = ((self.price_of_barbells + self.price_of_dumbbells + self.price_of_machines + self.price_of_plates )*0.15)
